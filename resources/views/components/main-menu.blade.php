...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">      
        ...
        <a style="margin-left: -120px; margin-top:-50px;" class="navbar-brand" href="#">
            <img src="{{asset('image\logo.png') }}" alt="" width="170" height="36">
        </a>
        <div style="margin-top:-40px;" class="collapse navbar-collapse" id="navbarSupportedContent">
